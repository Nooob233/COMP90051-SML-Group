...
## Data Sets
The detailed introductions are in the `data` folder. `raw` saves the original data, `processed` saves the data generated during the pre-processing and the final merged data. `train_test` folder contains the data used for training and evaluating the model in the second and third years.
